...
import Profile1 from "../assets/img/team/profile-picture.jpeg";
import ProfileCover from "../assets/img/team/profile-picture.jpeg";
  ...
  return (
    <Card border="light" className="shadow-sm">
      ...
      <Card.Body>
        ...
        <Progress last title="Darwinex - Dashboard" color="purple" icon={faBootstrap} percentage={34} />
      </Card.Body>
    </Card>
  );
};
